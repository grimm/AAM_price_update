...
Vendors = ["aci", "adu", "ard", "baja", "big", "bkr", "curt", "eccon", "eccot", "fia", "gor",
           "gorm", "kar", "knk", "knn", "kso", "nfa", "par", "piaa", "prime", "protec",
           "scs", "tech", "tim", "trux", "rch", "rig", "rsp", "warn", "wes", "west", "yak"]
vendor_cal = {}
product_groups = {}
