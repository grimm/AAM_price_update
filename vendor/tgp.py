...
# tgp.py
#
# This script holds functions for the vendor Tommy Gate Parts (Nelson only)
#
# Initial version - 08/04/2022 - Jason Grimes
#
...
def do_tgp(vendor_pandas, tech_cal):
    ...
    vendor_pandas["NewPart"] = vendor_pandas["Part Number"].apply(lambda x: "TGP" + x)
    ...
    vendor_pandas["P2"] = vendor_pandas["MSRP"].astype(float)
    vendor_pandas["P5"] = vendor_pandas["Dist. Price"].astype(float)

    vendor_pandas["P1"] = vendor_pandas["P2"] * 1.15
