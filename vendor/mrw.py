...
def do_mrw(vendor_pandas, tech_cal):
    ...
    frames = [vendor_pandas["WHEELS"], vendor_pandas["ACCESSORIES"]]
    ...
    vendor_pandas["FREIGHT WEIGHT (LBS)"] = vendor_pandas["FREIGHT WEIGHT (LBS)"].fillna(vendor_pandas["WEIGHT"])
    ...
    vendor_pandas = vendor_pandas[(vendor_pandas[r"PURCHASE PRICE"] != "0")]
    vendor_pandas = vendor_pandas[(vendor_pandas[r"PURCHASE PRICE"] != "Closeout")]
    vendor_pandas = vendor_pandas.reset_index(drop=True)

    # Create new Status/NewPart columns
    vendor_pandas['Part Number'] = vendor_pandas['PART NUMBER'].astype(str)
    # vendor_pandas['Part Number'] = vendor_pandas['CWH\nPart#'].astype(str)
    ...
    vendor_pandas["P5"] = vendor_pandas["PURCHASE PRICE"]
