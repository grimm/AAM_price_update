...
# ext.py
#
# This script holds functions for the vendor Extang manufacturer file
#
# Initial version - 03/01/2022 - Jason Grimes
#
...
def do_ext(vendor_pandas, tech_cal):
    ...
    vendor_pandas["P1"] = vendor_pandas["US MSRP 4.1.22"].astype(float)
    vendor_pandas["P3"] = vendor_pandas["US Jobber 4.1.22"].astype(float)
