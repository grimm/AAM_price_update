...
# bak.py
#
# This script holds functions for the vendor BAK INDUSTRIES
#
...
def do_bak(vendor_pandas, tech_cal):
    ...
    vendor_pandas["NewPart"] = vendor_pandas["Part Number"].astype(str).apply(lambda x: "BAK" + x)
