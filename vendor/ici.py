...
# ici.py
#
# This script holds functions for the vendor Innovavtive Creations
#
# Initial version - 07/27/2022 - Jason Grimes
#
...
def do_ici(vendor_pandas, tech_cal):
    ...
    vendor_pandas["NewPart"] = vendor_pandas["NewPart"].apply(lambda x: "ICI" + x)
