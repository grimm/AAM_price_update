...
# hyp.py
#
# This script holds functions for the vendor HyperTech
#
# Initial version - 07/18/2022 - Jason Grimes
#
...
def do_hyp(vendor_pandas, tech_cal):
    ...
    vendor_pandas["NewPart"] = vendor_pandas["NewPart"].apply(lambda x: "HYP" + x)
