...
# edge.py
#
# This script holds functions for the vendor Holley brand Edge
#
# Initial version - 06/17/2022 - Jason Grimes
#
...
def do_edge(vendor_pandas, tech_cal):
    # Remove all rows that are not part of the brand
    vendor_pandas = vendor_pandas[(vendor_pandas["Brand"] == "Edge")]
    ...
    vendor_pandas["NewPart"] = vendor_pandas["Part Number"].apply(lambda x: "EDGE" + x)
