...
def do_fire(vendor_pandas, prod_group, tech_cal):
    ...
    vendor_pandas['Part Number'] = vendor_pandas['Kit Number'].astype(str)
    vendor_pandas["NewPart"] = vendor_pandas["4-Digit"].apply(lambda x: "PIAA" + x)
