...
def do_mba(vendor_pandas, tech_cal):
    ...
    vendor_pandas["Length"] = vendor_pandas["Length"].replace("", "0").astype(str)
    vendor_pandas["Width"] = vendor_pandas["Width"].replace("", "0").astype(str)
    vendor_pandas["Height"] = vendor_pandas["Height"].replace("", "0").astype(str)
