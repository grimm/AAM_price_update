...
# bdw.py
#
# This script holds functions for the vendor Bulldog Wenches
#
# Initial version - 08/10/2022 - Jason Grimes
#
...
def do_bdw(vendor_pandas, tech_cal):
    ...
    vendor_pandas["NewPart"] = vendor_pandas["NewPart"].apply(lambda x: "BDW" + x)
